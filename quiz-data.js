/**
 * SananHistory - Tarix Biliyi Yoxlama Testi
...
// Nəticəyə uyğun təmkinli və peşəkar tövsiyə generatoru
function getQuizRecommendation(score, total) {
  ...
  if (percentage === 100) {
    return {
      ...
      description: "Tarix üzrə təməl bilikləriniz möhkəmdir. İmtahanlarda ən yüksək balı toplamaq və ya olimpiada/MİQ mərhələsində uğur qazanmaq üçün dərinləşdirilmiş mövzu təhlilləri proqramımız sizin üçün uyğundur.",
